        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(url('employees')); ?>"
                            class="nav-link">Employee List</a></li>
                </ul>
                <hr class="d-lg-none text-white-50">
                <a href="<?php echo e(url('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto"><i
...
<?php /**PATH D:\Rafi\SEM 6\ISC22L3 - PEMROGRAMAN FRAMEWORK\Project\Project5\laravel\resources\views/home.blade.php ENDPATH**/ ?>